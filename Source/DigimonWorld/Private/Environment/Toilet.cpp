...
{
	Super::BeginPlay();
	BoxComponent->OnComponentBeginOverlap.AddDynamic(this, &AToilet::OnTriggerOverlapped);
}

void AToilet::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	BoxComponent->OnComponentBeginOverlap.RemoveDynamic(this, &AToilet::OnTriggerOverlapped);
	Super::EndPlay(EndPlayReason);
}

void AToilet::OnTriggerOverlapped(UPrimitiveComponent* OverlappedComponent,
